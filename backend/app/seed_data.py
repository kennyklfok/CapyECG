...
EXPLANATIONS = {
    ...
    "Junctional rhythm": "A regular narrow-complex rhythm arises near the AV junction, so P waves may be absent or inverted.",
...
KEY_FEATURES = {
    ...
    "Junctional rhythm": ["Regular narrow rhythm", "Absent or inverted P waves", "Rate often 40-60"],
